$('document').ready(()=>{
    ...
    async function funcionGetPartyroomAndClient(){
        ...
        const peticion2 = await fetch('http://144.22.251.90:8080/api/Client/all' , {
            method:'GET',
            headers:{
                'Content-Type':'application/json'
            }
    ...
    async function funcionGet(){
        const peticion = await fetch("http://144.22.251.90:8080/api/Reservation/all",{
            method:'GET',
            headers:{
                'Content-Type':'application/json'
            }
    ...
    async function Getcalificaciones(){
        const peticionCalificacion = await fetch("http://144.22.251.90:8080/api/Score/all",{
                method:'GET',
                headers:{
                    'Content-Type':'application/json'
                }
    ...
    async function funcionPostCategorias(){
        ...
        const peticion = await fetch('http://144.22.251.90:8080/api/Score/save' ,{
            method:'POST',
            headers:{
                'Content-type':'application/json'
            },
    ...
    async function funcionPost(){
        ...
        const peticion = await fetch('http://144.22.251.90:8080/api/Reservation/save' ,{
            method:'POST',
            headers:{
                'Content-type':'application/json'
            },
